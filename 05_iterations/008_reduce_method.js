...
// const myTotal = myNums.reduce(function (acc, currval) {            // acc = accumulator, currval = current value, 0 = initial value
//     console.log(`acc: ${acc} and currval: ${currval}`);            // here accumulator(previous value) take the initial value and the sum of accumulator & current value saved again in accumulator
//     return acc + currval
// }, 0)
